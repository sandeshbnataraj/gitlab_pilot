...
IF NOT EXISTS (SELECT 1 FROM system_config WHERE [key] = 'img_db_index')
BEGIN
    INSERT INTO system_config (system_config_id,module,category,[key],[value],date_modified,last_updated_by) 
        VALUES (NEWID(),'general','DB','img_db_index',2,dbo.f_getcustom_date(),'admin')
END