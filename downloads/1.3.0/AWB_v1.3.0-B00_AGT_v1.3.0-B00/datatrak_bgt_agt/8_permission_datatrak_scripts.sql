...
raiserror('Deployment aborted due to incompatible datatrak_bgt_agt version!!!',20,-1) WITH LOG

else

print 'Proceed with the deployment as correct datatrak_bgt_agt version is being used...'
